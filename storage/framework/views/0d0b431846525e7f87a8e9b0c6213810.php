...
<body class="antialiased bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-sans selection:bg-indigo-500/30 selection:text-indigo-900">
            ...
            <div class="flex items-center gap-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('login')): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        ...
                        ?>
                        <a href="<?php echo e($dashboardUrl); ?>" class="text-sm font-bold bg-zinc-100 dark:bg-zinc-800 px-4 py-2 rounded-full hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors">My Dashboard</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-sm font-semibold hover:text-indigo-600 transition-colors">Log in</a>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="text-sm font-semibold bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 px-4 py-2 rounded-full hover:-translate-y-0.5 hover:shadow-lg transition-all">Sign up &rarr;</a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <a href="#" class="group flex flex-col p-6 rounded-3xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800/50 hover:border-indigo-200 dark:hover:border-indigo-500/30 hover:shadow-lg transition-all duration-300 items-center justify-center text-center">
                        ...
                        <h3 class="font-bold text-zinc-900 dark:text-zinc-100 line-clamp-1"><?php echo e($category->name); ?></h3>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Digital Art', 'Web Design', 'Handmade', 'Consulting', 'Electronics', 'Apparel']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mockTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                     <div class="group flex flex-col p-6 rounded-3xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800/50 hover:border-indigo-200 dark:hover:border-indigo-500/30 hover:shadow-lg transition-all items-center text-center opacity-70">
                        ...
                        <h3 class="font-bold text-zinc-600 dark:text-zinc-300 text-sm"><?php echo e($mockTitle); ?></h3>
                    </div>
    ...
    <section id="featured" class="py-24 bg-zinc-50 dark:bg-zinc-950">
        <div class="max-w-7xl mx-auto px-6">
            <div class="mb-12 flex flex-col sm:flex-row justify-between items-end gap-4">
                ...
                <a href="<?php echo e(route('register')); ?>" class="text-sm font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 flex items-center gap-1">
            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $latestListings ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div class="group flex flex-col rounded-3xl bg-white dark:bg-zinc-900 shadow-sm border border-zinc-200 dark:border-zinc-800 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                        <div class="aspect-[4/3] bg-zinc-100 dark:bg-zinc-800 relative overflow-hidden">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($listing->images)): ?>
                                <img src="<?php echo e(Storage::url($listing->images[0])); ?>" alt="<?php echo e($listing->title); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                            <?php else: ?>
                        ...
                        <div class="p-5 flex flex-col flex-grow">
                            <div class="flex items-center gap-2 mb-2">
                                <span class="bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 text-xs font-bold px-2 py-0.5 rounded-full uppercase tracking-wide">
                                    <?php echo e($listing->type === 'product' ? 'Product' : 'Service'); ?>

                                </span>
                                <span class="text-xs text-zinc-500 truncate"><?php echo e($listing->category->name ?? 'Uncategorized'); ?></span>
                            </div>
                            ...
                            <div class="mt-auto pt-4 border-t border-zinc-100 dark:border-zinc-800/50 flex items-center justify-between">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($listing->store && $listing->store->slug): ?>
                                    <a href="<?php echo e(route('store.show', $listing->store->slug)); ?>" class="flex items-center gap-2 group/store hover:opacity-80 transition-opacity">
                                        <div class="h-6 w-6 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center text-xs font-bold shadow-sm group-hover/store:bg-indigo-600 group-hover/store:text-white transition-colors">
                                            <?php echo e(substr($listing->store->name ?? 'S', 0, 1)); ?>

                                        </div>
                                        <span class="text-xs font-medium text-zinc-600 dark:text-zinc-400 truncate w-24 group-hover/store:text-indigo-600 dark:group-hover/store:text-indigo-400 transition-colors"><?php echo e($listing->store->name ?? 'Store'); ?></span>
                                    </a>
                                    <a href="<?php echo e(route('store.show', $listing->store->slug)); ?>" class="text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors" title="Visit Store">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 4; $i++): ?>
                        <div class="group flex flex-col rounded-3xl bg-white dark:bg-zinc-900 shadow-sm border border-zinc-200 dark:border-zinc-800 overflow-hidden opacity-60 pointer-events-none">
                            ...
                            <div class="p-5 flex flex-col">
                                <h3 class="font-bold text-zinc-400 mb-2">Placeholder Listing <?php echo e($i); ?></h3>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($latestListings ?? collect())->count() > 0): ?>
            <div class="mt-12 text-center">
                <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center gap-2 rounded-full bg-zinc-900 dark:bg-white px-6 py-3 text-sm font-bold text-white dark:text-zinc-900 shadow-sm hover:-translate-y-0.5 transition-transform">
                    Sign up to see more
                </a>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <footer class="border-t border-zinc-200 dark:border-zinc-800 pt-16 pb-8 bg-white dark:bg-zinc-950 mt-auto">
        <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <p class="text-zinc-500 dark:text-zinc-400 text-sm">&copy; <?php echo e(date('Y')); ?> Sahel-DigiMart. All rights reserved.</p>
        </div>
    </footer>

</body>
</html><?php /**PATH C:\PROJECTS\gusau\resources\views/welcome.blade.php ENDPATH**/ ?>