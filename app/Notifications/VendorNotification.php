...
class VendorNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        $message = (new MailMessage)
            ->subject($this->data['title'] ?? 'Vendor Notification')
        ...
        return $message->line('Thank you for selling on Sahel DigiMart!');
    }
    ...
    {
        return [
            'title' => $this->data['title'] ?? 'Vendor Notification',
            'message' => $this->data['message'],
            'action_url' => $this->data['action_url'] ?? null,
            'type' => $this->data['type'] ?? 'vendor_alert'
        ];
    }
}
